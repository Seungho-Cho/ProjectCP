        ...
        GestureValue
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        GMap.insertEdge(4, 5);
        GMap.insertEdge(4, 6);
        GMap.insertEdge(5, 18);
        GMap.insertEdge(6, 7);
        GMap.insertEdge(6, 8);
        GMap.insertEdge(8, 9);
        GMap.insertEdge(8, 10);
        GMap.insertEdge(8, 11);
        GMap.insertEdge(8, 16);
        GMap.insertEdge(11, 12);
        GMap.insertEdge(11, 13);
        GMap.insertEdge(11, 15);
        GMap.insertEdge(13, 14);
        GMap.insertEdge(15, 22);
        GMap.insertEdge(16, 17);
        GMap.insertEdge(16, 19);
        GMap.insertEdge(17, 18);
        GMap.insertEdge(17, 24);
        GMap.insertEdge(18, 26);
        GMap.insertEdge(19, 20);
        GMap.insertEdge(19, 21);
        GMap.insertEdge(19, 22);
        GMap.insertEdge(21, 25);
        GMap.insertEdge(22, 23);
        GMap.insertEdge(22, 31);
        GMap.insertEdge(24, 25);
        GMap.insertEdge(24, 29);
        GMap.insertEdge(25, 30);
        GMap.insertEdge(26, 27);
        GMap.insertEdge(26, 28);
        GMap.insertEdge(26, 38);
        GMap.insertEdge(28, 29);
        GMap.insertEdge(29, 34);
        GMap.insertEdge(30, 31);
        GMap.insertEdge(30, 36);
        GMap.insertEdge(31, 32);
        GMap.insertEdge(31, 33);
        GMap.insertEdge(31, 45);
        GMap.insertEdge(34, 35);
        GMap.insertEdge(34, 41);
        GMap.insertEdge(35, 36);
        GMap.insertEdge(35, 37);
        GMap.insertEdge(37, 42);
        GMap.insertEdge(38, 39);
        GMap.insertEdge(39, 40);
        GMap.insertEdge(41, 42);
        GMap.insertEdge(41, 46);
        GMap.insertEdge(42, 43);
        GMap.insertEdge(42, 49);
        GMap.insertEdge(43, 44);
        GMap.insertEdge(43, 45);
        GMap.insertEdge(45, 51);
        GMap.insertEdge(46, 47);
        GMap.insertEdge(46, 48);
        GMap.insertEdge(48, 49);
        GMap.insertEdge(49, 50);
        GMap.insertEdge(50, 51);
        GMap.insertEdge(50, 53);
        GMap.insertEdge(51, 52);
        GMap.insertEdge(51, 55);
        GMap.insertEdge(53, 54);
        GMap.insertEdge(53, 56);
        GMap.insertEdge(55, 58);
        GMap.insertEdge(56, 57);
        GMap.insertEdge(56, 58);
